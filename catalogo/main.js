let dataProductos = {
  data: [
    ...
    {id: '005', name: "morron", type: "verdura", price: "170", img: "morron.png" },
    {id: '006', name: "brocoli", type: "verdura", price: "400", img: "brocoli.png" },
    {id: '007', name: "coliflor", type: "verdura", price: "350", img: "coliflor.png" },
    {id: '008', name: "kiwi", type: "verdura", price: "120", img: "kiwi.png" },
    {id: '009', name: "esponja", type: "aseo", price: "300", img: "esponja.png" },
    {id: '010', name: "ariel", type: "aseo", price: "2000", img: "ariel.png" },
    {id: '011', name: "cif", type: "aseo", price: "1500", img: "cif.png" },
    {id: '012', name: "escoba", type: "aseo", price: "1750", img: "escoba.png" },
    {id: '013', name: "guantes", type: "aseo", price: "150", img: "guantes.png" },
    {id: '014', name: "cocacola", type: "gaseosa", price: "2000", img: "coca.png" },
    ...
    {id: '027',name: "sal", type: "cocina", price: "800", img: "sal.png" },
    {id: '028',name: "aceite", type: "cocina", price: "1100", img: "aceite.png" },
    {id: '029',name: "gomitas", type: "dulces", price: "20", img: "gomitas.png" },
    {id: '030',name: "malvaviscos", type: "dulces", price: "50", img: "malvaviscos.png" },
    {id: '031',name: "chocolate", type: "dulces", price: "200", img: "chocolate.png" },
    {id: '032',name: "piruletas", type: "dulces", price: "150", img: "piruletas.png" },
    {id: '033',name: "oreo", type: "dulces", price: "500", img: "oreo.png" },
  ],
};
...
document.getElementById("buscador").addEventListener('click',() => {
  let buscadorInput = document.getElementById('buscador-input').value;
  let elemen = document.querySelectorAll('.producto-name');
  let tarjet = document.querySelectorAll('.tarjeta')
